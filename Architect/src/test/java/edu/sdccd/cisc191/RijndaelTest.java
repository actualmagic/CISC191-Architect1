...
public class RijndaelTest {
    ...
    public void basicEncryptionECB() {
        ...
        Rijndael aes = new Rijndael(inputText, cipherKey, "ECB", true);
        aes.encode();
    }
    ...
    public void testVectorECB() {
        ...
        aes = new Rijndael(cipherText, cipherKey, "ECB", true);
    ...
    public void testVectorCTR() {
        ...
        Rijndael aes = new Rijndael(inputText, cipherKey, "CTR", true);
        String cipherText = aes.encode();
        ...
        aes = new Rijndael(cipherText, cipherKey, "CTR", true);
        String plainText = aes.decode();
        assertEquals(inputText.toUpperCase(), plainText.replaceAll(" ", ""));
    }

    @Test
    public void testEncryptionWithASCII() {
        String inputText = "abcdefghijklmnopqrstuvwxyz";
        String cipherKey = "2b7e151628aed2a6abf7158809cf4f3c" + "f0f1f2f3f4f5f6f7f8f9fafbfcfdfeff";
        Rijndael aes = new Rijndael(inputText, cipherKey, "CTR", false);
        assertEquals("8d ee bc 17 fd 06 1b d8 9b b8 7d 19 87 f0 ce 94 47 59 0f 48 12 05 26 1b 61 da ", aes.encode().toLowerCase());
    }
}